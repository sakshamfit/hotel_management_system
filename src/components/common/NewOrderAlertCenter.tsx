...
// ---------------------------------------------------------------------------
// Web Audio API siren + Web Speech API announcement — shared with Settings'
// "Test Siren" button (src/utils/alertSound.ts) so there is one implementation.
// ---------------------------------------------------------------------------

import {
  getAlertAudioContext as getAudioContext,
  unlockAlertAudio as unlockAudio,
  playAlertSiren as playAlertSound,
  speakAlertText as speakText,
