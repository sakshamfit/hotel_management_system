    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-3.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h2 className="text-base font-bold text-[#222222]">Restaurant & F&B Menu</h2>
      ...
      {loading ? (
        <div className="bg-white border border-[#ebebeb] rounded-3xl p-12 text-center">
          ...
          <p className="text-xs text-[#6a6a6a] mt-3">Loading menu items from Firestore...</p>
        </div>
            ...
            return (
              ...
              >
                <div>
                    ...
                    <div>
                      <div className="flex items-center gap-1.5">
                        ...
                        {(item.isVegetarian || (item as any).isVeg) && (
                          <span className="p-0.5 rounded-full bg-emerald-50 text-emerald-600 border border-emerald-200 text-[10px]" title="Vegetarian">
                  ...
                  <div className="flex items-center gap-2 mt-3 text-[11px] text-[#6a6a6a]">
                ...
                <div className="mt-4 pt-3 border-t border-[#ebebeb] flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-1">
                    <button
                      ...
                      title="Edit Item"
                      className="p-2 rounded-full hover:bg-[#f7f7f7] text-[#6a6a6a] hover:text-[#222222]"
                    >
                    ...
                    <button
                      ...
                      title="Delete Item"
                      className="p-2 rounded-full hover:bg-rose-50 text-[#6a6a6a] hover:text-rose-600"
                    >
            ...
            <form onSubmit={handleSaveItem} className="space-y-3.5">
              <div>
                <label className="block text-xs font-semibold text-[#222222] mb-1">
                  Dish / Item Name <span className="text-[#ff385c]">*</span>
                </label>
                <input
                  type="text"
                  required
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-semibold text-[#222222] mb-1">
                    Category <span className="text-[#ff385c]">*</span>
                  </label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block text-xs font-semibold text-[#222222] mb-1">
                    Price ({hotel.currencySymbol || '$'}) <span className="text-[#ff385c]">*</span>
                  </label>
                  <input
                    type="number"
                    min="0"
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="flex items-center pt-5">
                  <label className="flex items-center gap-2 cursor-pointer">
                    ...
                    />
                    <span className="text-xs font-medium text-[#222222]">Vegetarian Dish</span>
                  </label>
                </div>
              </div>
